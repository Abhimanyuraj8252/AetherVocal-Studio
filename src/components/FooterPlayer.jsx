  ...
  return (
    <footer className="sticky-player-bar">
      <div className="player-bar-container">
        ...
        {/* Main Action Bar Row */}
        <div className="player-bar-main-row">
          {/* Left Settings Controls Group */}
          <div className="player-controls-left">
            {/* Format Selector */}
            <div className="player-format-picker">
              <span className="format-label">Format:</span>
              <div className="player-segmented-control">
                <button
                  type="button"
                  className={`player-segmented-btn ${selectedFormat === 'wav' ? 'active' : ''}`}
                ...
                <button
                  type="button"
                  className={`player-segmented-btn ${selectedFormat === 'webm' ? 'active' : ''}`}
            ...
            <div className="player-format-picker">
              ...
              <div className="player-segmented-control">
                <button
                  type="button"
                  className={`player-segmented-btn ${enableCompression ? 'active' : ''}`}
